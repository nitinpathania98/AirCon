        ...
        <>
            ...
            <div className="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
                <div className="container text-center py-5">
                    <h1 className="display-2 text-white mb-4 animated slideInDown">Register</h1>
                    <nav aria-label="breadcrumb animated slideInDown">
                        <ol className="breadcrumb justify-content-center mb-0">
                            <li className="breadcrumb-item"><a href="#">Home</a></li>
                            <li className="breadcrumb-item"><a href="#">Pages</a></li>
                            <li className="breadcrumb-item text-primary" aria-current="page">Register</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <form  method="post">
                                <div className="row g-3">
                                    ...
                                    <div className="col-12">
                                        <button className="btn btn-primary rounded-pill py-3 px-5" onSubmit={Onhandleform} type="submit">Send Message</button>
                                    </div>
                                </div>
                            </form>
                        </div>
